...
class EstudianteServiceImplTest {
    ...
    void findAllByServicio() {
        ...
        var estudianteDTOS = this.estudianteService.findAllByServicio(5, 10, true);
        ...
        assertEquals(2, estudianteDTOS.getContent().size());
        assertEquals(estudianteDTOS.getContent().get(0).getCarnet(), "zh1");
        assertEquals(estudianteDTOS.getContent().get(1).getCarnet(), "zh2");
